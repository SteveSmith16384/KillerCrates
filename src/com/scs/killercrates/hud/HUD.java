...
import com.scs.killercrates.gui.TextArea;
...
public class HUD extends Node implements IEntity, IProcessable {
	...
	public HUD(KillerCrates _game, GameModule _module, float x, float y, float w, float h, BitmapFont font_small, int id, Camera _cam) {
		super("HUD");
